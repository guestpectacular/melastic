...
use \Guestpectacular\Melastic\EngineManager as Eaea;
...
trait Searchable
{
    ...
    public function queueMakeSearchable($models)
    {
        ...
        dispatch((new Melastic::$makeSearchableJob($models))
    ...
    public function queueRemoveFromSearch($models)
    {
        ...
        dispatch(new Melastic::$removeFromSearchJob($models))
            ->onQueue($models->first()->syncWithSearchUsingQueue())
            ->onConnection($models->first()->syncWithSearchUsing());
    }
     ...
     * @return \Guestpectacular\Melastic\Builder
     */
     ...
     *
     * @param  \Guestpectacular\Melastic\Builder  $builder
     * @param  array  $ids
     * @return mixed
     */
